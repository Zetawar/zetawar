...
(defrecord Router [datascript timbre conn ev-chan notify-chan notify-pub players]
  ...
  (stop [component]
    ...
    (assoc component
           :datascript nil :timbre nil :conn nil
           :ev-chan nil :notify-chan nil :notify-pub nil :players nil)))
...
(defn new-router
  ...
  ([ev-chan notify-chan players]
   (component/using (map->Router {:ev-chan ev-chan :notify-chan notify-chan :players players})
                    [:datascript :timbre])))
